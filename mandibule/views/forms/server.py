...
from mandibule.views.widgets.fields import \
...
class ServerForm(QtGui.QDialog):
    ...
    def __init__(self, app, id_=None, data=None):
        ...
        group_id = data and data.get('group_id') \
            or self.app.actions.get_group_id()
        # Fields
    ...
    def accept(self):
        ...
        if self.id_:
            self.app.server_ctl.update(self.id_, self.data)
        else:
            self.app.server_ctl.create(self.data)
